...
import { Search, Navigation, Layers, ZoomIn, ZoomOut, Maximize2 } from 'lucide-react';
        ...
        <div style={styles.locationInfo}>
          ...
          <div style={styles.locationStats}>
            <div style={styles.locationStat}>
              ...
              <div>
                <div style={styles.statLabel}>AQI</div>
                <div style={{...styles.statValue, color: getAqiColor(searchedLocation.aqi)}}>
            ...
            {searchedLocation.temperature !== undefined && (
              <div style={styles.locationStat}>
                ...
                <div>
                  ...
                  <div style={styles.statValue}>{searchedLocation.temperature}°C</div>
